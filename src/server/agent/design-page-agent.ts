...
import type { ProjectOutputType } from "@/server/workspace-store";
import { WorkspaceStore } from "@/server/workspace-store";
import { createProjectWorkspaceTools } from "@/server/agent/tools/project-workspace-tools";
import { buildFrontendCapabilityPrompt } from "@/server/realtime/frontend-capabilities";
