...
For new page mode, instruct the agent to create a new page. Do not forbid related edits such as adding navigation links, reusing shared components, or inserting shared component markers.
