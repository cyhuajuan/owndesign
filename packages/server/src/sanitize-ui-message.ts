...
export function sanitizePublicConversation(conversation: ConversationRecord): ConversationRecord {
  return {
    ...conversation,
    messages: Array.isArray(conversation.messages)
      ? conversation.messages.map((message) => sanitizePublicUIMessage(message as UIMessage))
...
export function sanitizePublicUIMessageChunk(chunk: UIMessageChunk): UIMessageChunk | undefined {
