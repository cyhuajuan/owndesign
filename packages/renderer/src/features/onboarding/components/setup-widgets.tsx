...
const CHECK_ICON = <CheckIcon aria-hidden="true" className="hidden group-[.selected]:block" />;
...
export function PanelDescription({ children }: { children: ReactNode }) {
  return <div className="mb-5 text-[13px] leading-relaxed text-[#6b6b76]">{children}</div>;
}
